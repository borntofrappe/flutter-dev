...
class Naive extends StatelessWidget {
  ...
  const Naive({Key? key}) : super(key: key);
        ...
        child: Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage('images/lake.jpg'), fit: BoxFit.fitWidth),
          ),
        ));
  }
}
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
          ...
          children: const [
            ColumnButton(icon: Icons.call, text: 'Call'),
            ColumnButton(icon: Icons.near_me, text: 'Route'),
            ColumnButton(icon: Icons.share, text: 'Share'),
          ]),
    );
  }
}
